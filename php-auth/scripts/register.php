...
global $fnError, $lnError, $emailError, $passwdStr, $passwdError, $userExistsError, $regSuccess;
...
if (isset($_POST["submit"])) {
    ...
    if(!preg_match("/^(?=[a-z])(?=[A-Z])[a-zA-Z]{8,}$/", $passwd)) {
        $passwdStr = '<p class="alert alert-danger"> Enter strong password.</p>';
    }
