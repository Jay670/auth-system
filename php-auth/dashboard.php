              ...
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="firstName" value="<?php echo $_SESSION['user']['firstname']; ?>" required>
                  </div>
                  <div class="form-group col-md-4">
                    <label for="InputLname">Lastname *</label>
                    <input type="text" class="form-control" name="lastName" value="<?php echo $_SESSION['user']['lastname']; ?>" required>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-4">
